...
export const GitHubMark = ({ s = 14 }: { s?: number }) => (
...
export const PopOut = ({ s = 11, stroke = 'currentColor' }: { s?: number; stroke?: string }) => (
  <svg width={s} height={s} viewBox="0 0 12 12" fill="none" stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M5 2.5H2.5v7h7V7M7 2.5h2.5V5M9.5 2.5L5.5 6.5" />
  </svg>
);
