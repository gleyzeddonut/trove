...
import { C, CHIP, mono } from '../tokens';
...
export function CommandChip({ p, onInstall }: Props) {
  return (
    <button
      ...
      style={{
        display: 'flex', alignItems: 'center', gap: 8, background: CHIP.bg,
        border: `1px solid ${CHIP.border}`, borderRadius: 9, padding: '7px 8px 7px 12px',
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          fontWeight: 600, color: '#E7EAEF', background: 'rgba(255,255,255,.06)', borderRadius: 6,
